...
config :live_view_native_guides, LiveViewNativeGuides.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "live_view_native_guides_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :live_view_native_guides, LiveViewNativeGuides.Mailer, adapter: Swoosh.Adapters.Test
